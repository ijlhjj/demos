...
public class JSplitPaneDemo {
	...
	public void init() {
		Book[] books = new Book[] {
				new Book("疯狂Java讲义", new ImageIcon(Const.classPath + "images/swing/java.png"), "介绍Java基础知识的入门书籍"),
				new Book("轻量级Java EE企业应用实战", new ImageIcon(Const.classPath + "images/swing/ee.png"),
						"全面介绍轻量级Java EE开发的三个常用框架"),
				new Book("疯狂Android讲义", new ImageIcon(Const.classPath + "images/swing/android.png"),
						"介绍Android开发的基础知识") };
