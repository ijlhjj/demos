...
public class ConvertMoney {
	private final static String[] STR_NUMBER = { "零", "壹", "贰", "叁", "肆", "伍", "陆", "柒", "捌", "玖" };// 大写数字
	...
	public static String convert(double d) {
		...
		if (strNum.indexOf(".") != -1) { // 整数单位只支持整数部分在12位以内
			String num = strNum.substring(0, strNum.indexOf("."));
			if (num.length() > 12) {
				System.out.println("数字超出可转换范围！");
				return "";
			}
		}
	...
	public static void main(String[] args) {
		System.out.println(convert(123456789.1234));
	}
